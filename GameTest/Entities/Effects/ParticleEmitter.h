...
public:
    ParticleEmitter(b2World *world, string name, b2Vec2 pos, GLfloat angle);
    ~ParticleEmitter();
    
    static ParticleEmitter* fromJsonData(b2World *w, Json::Value data, int index, string);
...
protected:
    ...
    GRender::Image *_particleTexture;
    bool _showTexture;
